    ...
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      ...
      <div className="bg-white border border-neutral-200 rounded-xl p-6">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-semibold text-neutral-900">Webhook URL</h2>
          <Button
        ...
        <div className="flex gap-2">
          <Input
            ...
            value={webhook?.url || ''}
            readOnly
            className="flex-1 font-mono text-sm bg-neutral-50"
          />
          <Button
            variant="outline"
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        >
          ...
          <div className="text-2xl font-bold text-neutral-900">{stats?.orders?.count || 0}</div>
        ...
        >
          ...
          <div className="text-2xl font-bold text-neutral-900">{stats?.stock?.count || 0}</div>
          <div className="text-xs text-neutral-500 mt-1">
        ...
        >
          ...
          <div className="text-2xl font-bold text-neutral-900">{stats?.tickets?.count || 0}</div>
          <div className="text-xs text-neutral-500 mt-1">
      ...
      {/* Data Formats */}
      <div className="bg-white border border-neutral-200 rounded-xl p-6">
        <h2 className="text-lg font-semibold text-neutral-900 mb-4">Veri Formatları</h2>
        ...
        <div className="space-y-3">
          ...
          <div className="border border-neutral-200 rounded-lg overflow-hidden">
            ...
            >
              <span className="font-medium text-neutral-700">Sipariş Verisi</span>
              {openAccordion === 'order' ? (
...
{`{
  ...
  "updated_at": "2024-12-19T10:30:00Z"
          ...
          <div className="border border-neutral-200 rounded-lg overflow-hidden">
            ...
            >
              <span className="font-medium text-neutral-700">Stok Verisi</span>
              {openAccordion === 'stock' ? (
                <ChevronUp className="h-5 w-5 text-neutral-500" />
              ) : (
                <ChevronDown className="h-5 w-5 text-neutral-500" />
...
{`{
  ...
  "updated_at": "2024-12-19T10:30:00Z"
          ...
          <div className="border border-neutral-200 rounded-lg overflow-hidden">
            ...
            >
              <span className="font-medium text-neutral-700">Servis/Arıza Verisi</span>
...
{`{
  ...
  "updated_at": "2024-12-19T10:30:00Z"
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
        <h2 className="text-lg font-semibold text-blue-900 mb-4">Nasıl Çalışır?</h2>
        <ol className="text-sm text-blue-800 space-y-2 list-decimal list-inside">
          ...
          <li>Her veri tipini (<code className="bg-blue-100 px-1 rounded">order</code>, <code className="bg-blue-100 px-1 rounded">stock</code>, <code className="bg-blue-100 px-1 rounded">ticket</code>) JSON formatında gönderin</li>
