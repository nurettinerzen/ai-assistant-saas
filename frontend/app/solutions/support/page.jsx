...
import { HeadphonesIcon, MessageCircle, HelpCircle, Clock, BarChart3 } from 'lucide-react';

export default function SupportSolutionPage() {
  const { t } = useLanguage();
  const flowSteps = [
    'solutions.support.exampleFlow.step1',
    'solutions.support.exampleFlow.step2',
    'solutions.support.exampleFlow.step3',
  ];

  const useCases = [
    {
      icon: MessageCircle,
      titleKey: 'solutions.support.useCase1.title',
      descKey: 'solutions.support.useCase1.desc',
    },
    {
      icon: HelpCircle,
      titleKey: 'solutions.support.useCase2.title',
      descKey: 'solutions.support.useCase2.desc',
    },
    {
      icon: Clock,
      titleKey: 'solutions.support.useCase3.title',
      descKey: 'solutions.support.useCase3.desc',
    },
    {
      icon: BarChart3,
      titleKey: 'solutions.support.useCase4.title',
      descKey: 'solutions.support.useCase4.desc',
    },
  ];
      ...
      <section className="pt-32 pb-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            >
              <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-green-500 to-emerald-500 flex items-center justify-center mx-auto mb-8">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-900 dark:text-white">
            {t('solutions.support.useCases.title')}
          </h2>
        ...
        <div className="container mx-auto px-4">
          <div className="glass rounded-3xl p-12 text-center max-w-4xl mx-auto dark:bg-neutral-800/60 dark:border dark:border-neutral-700">
            <h2 className="text-4xl font-bold mb-6 text-gray-900 dark:text-white">
              {t('solutions.support.cta.title')}
            </h2>
            <p className="text-xl text-gray-600 dark:text-neutral-400 mb-8 max-w-2xl mx-auto">
              {t('solutions.support.cta.subtitle')}
            </p>
