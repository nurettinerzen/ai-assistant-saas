...
import { ShoppingCart, Package, Truck, RotateCcw, MessageCircle } from 'lucide-react';
...
export default function EcommerceSolutionPage() {
  ...
  const flowSteps = [
    'solutions.ecommerce.exampleFlow.step1',
    'solutions.ecommerce.exampleFlow.step2',
    'solutions.ecommerce.exampleFlow.step3',
  ];
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-neutral-950">
      ...
      <section className="py-16 bg-gray-50 dark:bg-neutral-900/50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-normal tracking-tight text-center mb-4 text-gray-900 dark:text-white">
