...
import { Scissors, Calendar, Bell, Users, Clock } from 'lucide-react';
...
export default function SalonSolutionPage() {
  ...
  const useCases = [
    {
      icon: Calendar,
      titleKey: 'solutions.salon.useCase1.title',
      descKey: 'solutions.salon.useCase1.desc',
    },
    {
      icon: Bell,
      titleKey: 'solutions.salon.useCase2.title',
      descKey: 'solutions.salon.useCase2.desc',
    },
    {
      icon: Users,
      titleKey: 'solutions.salon.useCase3.title',
      descKey: 'solutions.salon.useCase3.desc',
    },
    {
      icon: Clock,
      titleKey: 'solutions.salon.useCase4.title',
      descKey: 'solutions.salon.useCase4.desc',
    },
  ];
