...
export default function MetricCard({
  ...
  const colorClasses = {
    ...
    warning: { bg: 'bg-amber-50', text: 'text-amber-600', sparkline: '#f59e0b' },
    danger: { bg: 'bg-red-50', text: 'text-red-600', sparkline: '#ef4444' },
    info: { bg: 'bg-blue-50', text: 'text-blue-600', sparkline: '#3b82f6' },
    purple: { bg: 'bg-purple-50', text: 'text-purple-600', sparkline: '#a855f7' },
  };
    ...
    return (
      <div className="bg-white rounded-xl border border-neutral-200 p-5 shadow-sm">
        <div className="animate-pulse">
          ...
          <div className="h-7 w-28 bg-neutral-200 rounded mb-4"></div>
  ...
  return (
    <div className="bg-white rounded-xl border border-neutral-200 p-5 shadow-sm hover:shadow-md transition-all duration-200">
      {/* Header */}
